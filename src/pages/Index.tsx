        ...
        <main className="flex-1 p-6 ml-64">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-blue-100 border border-blue-300 rounded-lg p-4 mb-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="text-blue-700 font-medium mb-1">Free API Integration</h3>
          ...
          {activeTab === "history" && (
            <div className="text-center py-20">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">Generation History</h2>
              <p className="text-blue-600">Your recent 3D model generations will appear here</p>
            </div>
          )}
        </main>
      </div>
