...
const CameraCapture = ({ capturedImages, setCapturedImages, compact = false }: CameraCaptureProps) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative group">
        <button
          onClick={startCamera}
          className={`w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2 ${
            compact ? 'py-3 px-4 text-sm' : 'py-4 px-6'
          }`}
        >
              ...
              <div key={index} className="relative group">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
                  <div className="flex items-center space-x-3">
                    <Camera className={`text-blue-400 flex-shrink-0 ${compact ? 'w-6 h-6' : 'w-8 h-8'}`} />
