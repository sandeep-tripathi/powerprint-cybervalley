...
const Header = () => {
  ...
  return (
    <header className="bg-blue-50/90 backdrop-blur-lg border-b border-blue-200 sticky top-0 z-50">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-8">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-2xl font-bold text-blue-900">PowerPrint</h1>
            </div>
            
            <nav className="hidden md:flex space-x-6">
              <a href="#" className="text-blue-900 hover:text-blue-600 transition-colors font-medium">Workspace</a>
              <a href="#" className="text-blue-700 hover:text-blue-600 transition-colors">Gallery</a>
              <a href="#" className="text-blue-700 hover:text-blue-600 transition-colors">Community</a>
              <a href="#" className="text-blue-700 hover:text-blue-600 transition-colors">Pricing</a>
            </nav>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <div className="relative hidden md:block">
              ...
              <input 
                ...
                className="bg-white/80 border border-blue-200 rounded-lg pl-10 pr-4 py-2 text-blue-900 placeholder-blue-400 focus:outline-none focus:border-blue-500 focus:bg-white w-64"
              />
            </div>
            
            <button className="relative p-2 text-blue-600 hover:text-blue-800 transition-colors">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-blue-900 hidden md:block font-medium">John Doe</span>
              </button>
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white/95 backdrop-blur-lg border border-blue-200 rounded-lg py-2 shadow-lg">
                  <button 
                    ...
                    className="flex items-center space-x-2 px-4 py-2 text-blue-600 hover:text-blue-700 hover:bg-blue-50 w-full text-left"
                  >
                    <Key className="w-4 h-4" />
                    <span>Generate API Key</span>
                  </button>
                  <hr className="my-2 border-blue-200" />
                  <a href="#" className="flex items-center space-x-2 px-4 py-2 text-blue-700 hover:text-blue-900 hover:bg-blue-50">
                  ...
                  <hr className="my-2 border-blue-200" />
                  <a href="#" className="block px-4 py-2 text-blue-700 hover:text-blue-900 hover:bg-blue-50">
                    Sign Out
                  </a>
                </div>
              )}
