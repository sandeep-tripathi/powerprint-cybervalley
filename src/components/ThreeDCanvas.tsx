...
const ThreeDCanvas = ({ 
  ...
  const handleDownload = () => {
    // Simple download functionality for the default panda model
    const objContent = `# 3D Panda Model
# Generated by Vision AI 3D Converter
v 0 0 0
v 1 0 0
v 0 1 0
f 1 2 3
  ...
  return (
    <div className="w-full h-full bg-gray-900 rounded-lg relative">
      ...
      <button
        ...
        className="absolute top-4 right-4 z-10 bg-purple-600 hover:bg-purple-700 text-white p-2 rounded-lg transition-colors shadow-lg"
      ...
      <Canvas camera={{ position: [6, 6, 6], fov: 60 }}>
        ...
        {/* Show default panda when no content */}
